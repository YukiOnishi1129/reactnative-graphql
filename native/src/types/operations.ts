...
export type SignInMutation = { __typename?: 'Mutation' } & {
  login: { __typename?: 'AuthenticateResponse' } & Pick<Types.AuthenticateResponse, 'token'> & {
...
export type SignUpMutation = { __typename?: 'Mutation' } & {
  register: { __typename?: 'AuthenticateResponse' } & Pick<Types.AuthenticateResponse, 'token'> & {
      user: { __typename?: 'User' } & GetUserFragment;
    };
};
...
export type CreateTodoMutation = { __typename?: 'Mutation' } & {
  createTodo: { __typename?: 'TodoResponse' } & { todo: { __typename?: 'Todo' } & GetTodoFragment };
};
...
export type UpdateTodoMutation = { __typename?: 'Mutation' } & {
  updateTodo: { __typename?: 'TodoResponse' } & { todo: { __typename?: 'Todo' } & GetTodoFragment };
};
...
export type DoneTodoMutation = { __typename?: 'Mutation' } & {
  doneTodo: { __typename?: 'TodoResponse' } & { todo: { __typename?: 'Todo' } & GetTodoFragment };
};
...
export type ActiveTodoMutation = { __typename?: 'Mutation' } & {
  activeTodo: { __typename?: 'TodoResponse' } & { todo: { __typename?: 'Todo' } & GetTodoFragment };
};
...
export type DeleteTodoMutation = { __typename?: 'Mutation' } & {
  deleteTodo: { __typename?: 'TodoResponse' } & { todo: { __typename?: 'Todo' } & GetTodoFragment };
};

export type NewTodoSubscriptionVariables = Types.Exact<{ [key: string]: never }>;

export type NewTodoSubscription = { __typename?: 'Subscription' } & {
  newTodo: { __typename?: 'Todo' } & GetTodoFragment;
};

export type UpdatedTodoSubscriptionVariables = Types.Exact<{ [key: string]: never }>;

export type UpdatedTodoSubscription = { __typename?: 'Subscription' } & {
  updatedTodo: { __typename?: 'Todo' } & GetTodoFragment;
};

export type HaveDoneTodoSubscriptionVariables = Types.Exact<{ [key: string]: never }>;

export type HaveDoneTodoSubscription = { __typename?: 'Subscription' } & {
  doneTodo: { __typename?: 'Todo' } & GetTodoFragment;
};

export type HaveActiveTodoSubscriptionVariables = Types.Exact<{ [key: string]: never }>;

export type HaveActiveTodoSubscription = { __typename?: 'Subscription' } & {
  activeTodo: { __typename?: 'Todo' } & GetTodoFragment;
};

export type DeletedTodoSubscriptionVariables = Types.Exact<{ [key: string]: never }>;

export type DeletedTodoSubscription = { __typename?: 'Subscription' } & {
  deletedTodo: { __typename?: 'Todo' } & GetTodoFragment;
};

export type NewAllTodoSubscriptionVariables = Types.Exact<{ [key: string]: never }>;
